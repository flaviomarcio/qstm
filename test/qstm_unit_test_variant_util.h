...
public:
    ...
    Q_INVOKABLE void test_Is()
    {
        {//uuid
            ...
            QVERIFY(vu.isUuid(varA));
            QVERIFY(vu.isUuid(varB));
            QVERIFY(!vu.isUuid(varC));
            QVERIFY(!vu.isUuid(varD));
            QVERIFY(vu.isUuid(varE));
            QVERIFY(vu.isUuid(varF));
        }
        ...
        {//hexa
            for (int var = 0; var < 100; ++var) {
                ...
                auto varE=varA+"---";
                auto varF="teste123";
                QVERIFY(vu.isHex(varA));
                QVERIFY(vu.isHex(varB));
                QVERIFY(vu.isHex(varC));
                QVERIFY(vu.isHex(varD));
                QVERIFY(!vu.isHex(varE));
                QVERIFY(!vu.isHex(varF));
            }
        }
        ...
        {//Base64
            for (int var = 0; var < 100; ++var) {
                ...
                auto varB=varA.toUpper();
                auto varC="1234";
                QVERIFY(vu.isBase64(varA));
                QVERIFY(vu.isBase64(varB));
                QVERIFY(vu.isBase64(varC));
            }
        }
    }
    ...
    Q_INVOKABLE void test_ToUuid()
    {
        ...
        QCOMPARE_EQ(vu.toUuid(var01), var01);
        QCOMPARE_EQ(vu.toUuid(var02), var01);
        QCOMPARE_EQ(vu.toUuid(var03), var03);
        QCOMPARE_EQ(vu.toUuid(var04), var03);
        QCOMPARE_EQ(vu.toUuid(var06), QUuid{});
        QCOMPARE_EQ(vu.toUuid(var07), QUuid{});
        QCOMPARE_EQ(vu.toUuid(var08), QUuid{});
    }
    ...
    Q_INVOKABLE void test_ToMd5()
    {
        ...
        QCOMPARE_EQ(vu.toMd5(var01), valueCheck);
        QCOMPARE_EQ(vu.toMd5(var02), valueCheck);
        QCOMPARE_EQ(vu.toMd5(var03), valueCheck);
        QCOMPARE_EQ(vu.toMd5(var04), valueCheck);
    }
    ...
    Q_INVOKABLE void test_ToMd5Uuid()
    {
        ...
        QCOMPARE_EQ(vu.toMd5Uuid(var01), valueCheck);
        QCOMPARE_EQ(vu.toMd5Uuid(var02), valueCheck);
        QCOMPARE_EQ(vu.toMd5Uuid(var03), valueCheck);
        QCOMPARE_EQ(vu.toMd5Uuid(var04), valueCheck);
    }
